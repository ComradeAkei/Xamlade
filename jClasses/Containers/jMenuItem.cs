...
namespace Xamlade.jClasses;
    ...
    public class jMenuItem : MenuItem, JControl, JSelectable, JChildContainer, JBroadcastHandler<JControl>
    {
        private string controlType => jElementType.MenuItem.ToString();
     ...
     //   public JChildContainer? jParent { get; set; }
        ...
        public jMenuItem()
        {
            ...
            Name = $"jMenuItem{Utils.NextgenIterator}";
